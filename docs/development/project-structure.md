...
│   ├── test_evaluation.cpp             eval: material scoring, pawn structure, tapered evaluation, pawn analysis functions, positional terms (bishop pair, rook files, rook on 7th, mobility, king safety, knight outpost)
