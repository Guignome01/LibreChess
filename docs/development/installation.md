...
If you're using different GPIO pins than the defaults, edit the pin definitions in `src/board/driver.h` before flashing. The default pins are documented in the [wiring guide](../hardware/wiring.md).
