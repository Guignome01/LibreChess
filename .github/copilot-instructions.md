...
### Class Hierarchy
**Core (`lib/core/`)**: Board representation, rules, movegen, evaluation, notation, FEN, EPD parsing — the foundation layer with zero Arduino dependencies. Purely consumed by game and engine.
