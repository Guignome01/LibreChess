...
│   ├── test_all.cpp                    Main entry: setUp/tearDown, register calls
│   ├── test_search.cpp                  search: mate-in-1, captures, quiescence, stalemate avoidance, iterative deepening, IID, time/stop, TT, move ordering, delta pruning, futility pruning, SEE ordering
