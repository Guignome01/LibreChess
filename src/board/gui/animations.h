#ifndef BOARD_GUI_ANIMATIONS_H
#define BOARD_GUI_ANIMATIONS_H
...
// ---------------------------------------------------------------------------
// GUI-owned animation vocabulary and frame painting. The generic scheduler owns
