#ifndef BOARD_RUNTIME_HELPERS_H
#define BOARD_RUNTIME_HELPERS_H
...
// ---------------------------------------------------------------------------
// Several visual/program classes store a BoardCanvasHandle and use the same
...
// Keeping that boilerplate here keeps those visual classes focused on painting.
// ---------------------------------------------------------------------------
