#ifndef BOARD_CORE_CALIBRATION_H
#define BOARD_CORE_CALIBRATION_H
...
// recalibration clears the saved mapping and reboots through Board::triggerCalibration().
// ---------------------------------------------------------------------------
...
#endif  // BOARD_CORE_CALIBRATION_H
