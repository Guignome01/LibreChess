#ifndef ENGINES_LIBRECHESS_ENGINE_H
#define ENGINES_LIBRECHESS_ENGINE_H
...
// ---------------------------------------------------------------------------
// LibreChessEngine implementation for the built-in LibreChess engine.
//
...
class LibreChessEngine : public AsyncEngineProvider {
 public:
  /// Provider identity stored in GameMeta for game resume.
  static constexpr uint8_t ENGINE_ID = Engines::LIBRECHESS_ENGINE_ID;
  ...
  explicit LibreChessEngine(LibreChess::Game* game,
                            int level = DEFAULT_LEVEL,
                            char playerColor = 'w',
                            LibreChess::ILogger* logger = nullptr);
  ~LibreChessEngine() override;
...
#endif  // ENGINES_LIBRECHESS_ENGINE_H
